...
#
# Generated by Vivado on Fri Dec 10 00:22:37 -0800 2021
# SW Build 3286242 on Wed Jul 28 13:10:47 MDT 2021
#
# Copyright 1986-2021 Xilinx, Inc. All Rights Reserved. 
#
# usage: float_accu.sh [-help]
# usage: float_accu.sh [-lib_map_path]
# usage: float_accu.sh [-noclean_files]
# usage: float_accu.sh [-reset_run]
#
...
# executing this script. Please type 'float_accu.sh -help' for more information.
#
...
# Design libraries
design_libs=(xilinx_vip xpm xbip_utils_v3_0_10 axi_utils_v2_0_6 xbip_pipe_v3_0_6 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_6 xbip_dsp48_multadd_v3_0_6 xbip_bram18k_v3_0_6 mult_gen_v12_0_17 floating_point_v7_1_12 xil_defaultlib)

# Simulation root library directory
sim_lib_dir="vcs_lib"

# Script info
echo -e "float_accu.sh - Script generated by export_simulation (Vivado v2021.1.1 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"D:/Programs/Xilinx/Vivado/2021.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"D:/Programs/Xilinx/Vivado/2021.1/data/xilinx_vip/include" \
  ...
  vlogan -work floating_point_v7_1_12 $vlogan_opts +v2k +incdir+"D:/Programs/Xilinx/Vivado/2021.1/data/xilinx_vip/include" \
    "$ref_dir/../../../ipstatic/hdl/floating_point_v7_1_rfs.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"D:/Programs/Xilinx/Vivado/2021.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../test.gen/sources_1/ip/float_accu/sim/float_accu.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.float_accu xil_defaultlib.glbl -o float_accu_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./float_accu_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./float_accu.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key float_accu_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc float_accu_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./float_accu.sh -help\" for more information)\n"
    exit 1
  fi
