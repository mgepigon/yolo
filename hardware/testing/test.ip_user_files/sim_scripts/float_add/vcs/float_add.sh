...
#
# Generated by Vivado on Wed Dec 08 22:33:23 -0800 2021
# SW Build 3286242 on Wed Jul 28 13:10:47 MDT 2021
#
# Copyright 1986-2021 Xilinx, Inc. All Rights Reserved. 
#
# usage: float_add.sh [-help]
# usage: float_add.sh [-lib_map_path]
# usage: float_add.sh [-noclean_files]
# usage: float_add.sh [-reset_run]
#
...
# executing this script. Please type 'float_add.sh -help' for more information.
#
...
# Script info
echo -e "float_add.sh - Script generated by export_simulation (Vivado v2021.1.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"D:/Programs/Xilinx/Vivado/2021.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../test.gen/sources_1/ip/float_add/sim/float_add.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.float_add xil_defaultlib.glbl -o float_add_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./float_add_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./float_add.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key float_add_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc float_add_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./float_add.sh -help\" for more information)\n"
    exit 1
  fi
