...
#
# Generated by Vivado on Thu Dec 09 20:59:04 -0800 2021
# SW Build 3286242 on Wed Jul 28 13:10:47 MDT 2021
#
# Copyright 1986-2021 Xilinx, Inc. All Rights Reserved. 
#
# usage: float_max.sh [-help]
# usage: float_max.sh [-lib_map_path]
# usage: float_max.sh [-noclean_files]
# usage: float_max.sh [-reset_run]
#
...
# executing this script. Please type 'float_max.sh -help' for more information.
#
...
# Script info
echo -e "float_max.sh - Script generated by export_simulation (Vivado v2021.1.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"D:/Programs/Xilinx/Vivado/2021.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../test.gen/sources_1/ip/float_max/sim/float_max.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.float_max xil_defaultlib.glbl -o float_max_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./float_max_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./float_max.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key float_max_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc float_max_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./float_max.sh -help\" for more information)\n"
    exit 1
  fi
