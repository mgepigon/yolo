...
module test
  ...
  wire [9:0]axi_smc_2_M00_AXI_ARADDR;
  wire axi_smc_2_M00_AXI_ARREADY;
  wire axi_smc_2_M00_AXI_ARVALID;
  wire [9:0]axi_smc_2_M00_AXI_AWADDR;
  ...
  wire [9:0]axi_smc_2_M01_AXI_ARADDR;
  wire axi_smc_2_M01_AXI_ARREADY;
  wire axi_smc_2_M01_AXI_ARVALID;
  wire [9:0]axi_smc_2_M01_AXI_AWADDR;
  wire axi_smc_2_M01_AXI_AWREADY;
  wire axi_smc_2_M01_AXI_AWVALID;
  wire axi_smc_2_M01_AXI_BREADY;
  wire [1:0]axi_smc_2_M01_AXI_BRESP;
  wire axi_smc_2_M01_AXI_BVALID;
  wire [31:0]axi_smc_2_M01_AXI_RDATA;
  wire axi_smc_2_M01_AXI_RREADY;
  wire [1:0]axi_smc_2_M01_AXI_RRESP;
  wire axi_smc_2_M01_AXI_RVALID;
  wire [31:0]axi_smc_2_M01_AXI_WDATA;
  wire axi_smc_2_M01_AXI_WREADY;
  wire axi_smc_2_M01_AXI_WVALID;
  ...
  wire [31:0]channel_add_0_M_AXIS_TDATA;
  wire [1:0]channel_add_0_M_AXIS_TKEEP;
  wire channel_add_0_M_AXIS_TLAST;
  wire channel_add_0_M_AXIS_TREADY;
  wire channel_add_0_M_AXIS_TVALID;
  ...
  test_axi_dma_from_pl_to_ps_0 axi_dma_from_pl_to_ps
       (.axi_resetn(rst_ps7_0_50M_peripheral_aresetn),
        ...
        .s_axi_lite_araddr(axi_smc_2_M00_AXI_ARADDR),
        .s_axi_lite_arready(axi_smc_2_M00_AXI_ARREADY),
        .s_axi_lite_arvalid(axi_smc_2_M00_AXI_ARVALID),
        .s_axi_lite_awaddr(axi_smc_2_M00_AXI_AWADDR),
        .s_axi_lite_awready(axi_smc_2_M00_AXI_AWREADY),
        .s_axi_lite_awvalid(axi_smc_2_M00_AXI_AWVALID),
        .s_axi_lite_bready(axi_smc_2_M00_AXI_BREADY),
        .s_axi_lite_bresp(axi_smc_2_M00_AXI_BRESP),
        .s_axi_lite_bvalid(axi_smc_2_M00_AXI_BVALID),
        .s_axi_lite_rdata(axi_smc_2_M00_AXI_RDATA),
        .s_axi_lite_rready(axi_smc_2_M00_AXI_RREADY),
        .s_axi_lite_rresp(axi_smc_2_M00_AXI_RRESP),
        .s_axi_lite_rvalid(axi_smc_2_M00_AXI_RVALID),
        .s_axi_lite_wdata(axi_smc_2_M00_AXI_WDATA),
        .s_axi_lite_wready(axi_smc_2_M00_AXI_WREADY),
        .s_axi_lite_wvalid(axi_smc_2_M00_AXI_WVALID),
  ...
  test_axi_dma_from_ps_to_pl_0 axi_dma_from_ps_to_pl
       (.axi_resetn(rst_ps7_0_50M_peripheral_aresetn),
        ...
        .s_axi_lite_aclk(processing_system7_0_FCLK_CLK0),
        .s_axi_lite_araddr(axi_smc_2_M01_AXI_ARADDR),
        .s_axi_lite_arready(axi_smc_2_M01_AXI_ARREADY),
        .s_axi_lite_arvalid(axi_smc_2_M01_AXI_ARVALID),
        .s_axi_lite_awaddr(axi_smc_2_M01_AXI_AWADDR),
        .s_axi_lite_awready(axi_smc_2_M01_AXI_AWREADY),
        .s_axi_lite_awvalid(axi_smc_2_M01_AXI_AWVALID),
        .s_axi_lite_bready(axi_smc_2_M01_AXI_BREADY),
        .s_axi_lite_bresp(axi_smc_2_M01_AXI_BRESP),
        .s_axi_lite_bvalid(axi_smc_2_M01_AXI_BVALID),
        .s_axi_lite_rdata(axi_smc_2_M01_AXI_RDATA),
        .s_axi_lite_rready(axi_smc_2_M01_AXI_RREADY),
        .s_axi_lite_rresp(axi_smc_2_M01_AXI_RRESP),
        .s_axi_lite_rvalid(axi_smc_2_M01_AXI_RVALID),
        .s_axi_lite_wdata(axi_smc_2_M01_AXI_WDATA),
        .s_axi_lite_wready(axi_smc_2_M01_AXI_WREADY),
        .s_axi_lite_wvalid(axi_smc_2_M01_AXI_WVALID));
  test_axi_smc_0 axi_smc
  ...
  test_axi_smc_2_0 axi_smc_2
       (.M00_AXI_araddr(axi_smc_2_M00_AXI_ARADDR),
        ...
        .M01_AXI_araddr(axi_smc_2_M01_AXI_ARADDR),
        .M01_AXI_arready(axi_smc_2_M01_AXI_ARREADY),
        .M01_AXI_arvalid(axi_smc_2_M01_AXI_ARVALID),
        .M01_AXI_awaddr(axi_smc_2_M01_AXI_AWADDR),
        .M01_AXI_awready(axi_smc_2_M01_AXI_AWREADY),
        .M01_AXI_awvalid(axi_smc_2_M01_AXI_AWVALID),
        .M01_AXI_bready(axi_smc_2_M01_AXI_BREADY),
        .M01_AXI_bresp(axi_smc_2_M01_AXI_BRESP),
        .M01_AXI_bvalid(axi_smc_2_M01_AXI_BVALID),
        .M01_AXI_rdata(axi_smc_2_M01_AXI_RDATA),
        .M01_AXI_rready(axi_smc_2_M01_AXI_RREADY),
        .M01_AXI_rresp(axi_smc_2_M01_AXI_RRESP),
        .M01_AXI_rvalid(axi_smc_2_M01_AXI_RVALID),
  ...
  test_axis_data_fifo_0_0 axis_data_fifo_out
       (.m_axis_tdata(axis_data_fifo_0_M_AXIS_TDATA),
        ...
        .s_axis_aclk(processing_system7_0_FCLK_CLK0),
        .s_axis_aresetn(rst_ps7_0_50M_interconnect_aresetn),
        .s_axis_tdata(channel_add_0_M_AXIS_TDATA),
        .s_axis_tkeep({1'b1,1'b1,channel_add_0_M_AXIS_TKEEP}),
        .s_axis_tlast(channel_add_0_M_AXIS_TLAST),
        .s_axis_tready(channel_add_0_M_AXIS_TREADY),
        .s_axis_tvalid(channel_add_0_M_AXIS_TVALID));
  test_channel_add_0_0 channel_add_0
       (.M_AXIS_ACLK(processing_system7_0_FCLK_CLK0),
        .M_AXIS_ARESETN(rst_ps7_0_50M_interconnect_aresetn),
        .M_AXIS_TDATA(channel_add_0_M_AXIS_TDATA),
        .M_AXIS_TKEEP(channel_add_0_M_AXIS_TKEEP),
        .M_AXIS_TLAST(channel_add_0_M_AXIS_TLAST),
        .M_AXIS_TREADY(channel_add_0_M_AXIS_TREADY),
        .M_AXIS_TVALID(channel_add_0_M_AXIS_TVALID),
        .S_AXIS_ACLK(processing_system7_0_FCLK_CLK0),
        .S_AXIS_ARESETN(rst_ps7_0_50M_interconnect_aresetn),
        .S_AXIS_TDATA(axis_data_fifo_in_M_AXIS_TDATA),
        .S_AXIS_TKEEP(axis_data_fifo_in_M_AXIS_TKEEP[1:0]),
  ...
  test_rst_ps7_0_50M_0 rst_ps7_0_50M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
