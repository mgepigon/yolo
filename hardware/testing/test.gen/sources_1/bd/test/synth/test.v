...
module test
  ...
  wire [15:0]conv2D_int16_0_M_AXIS_TDATA;
  wire [1:0]conv2D_int16_0_M_AXIS_TKEEP;
  wire conv2D_int16_0_M_AXIS_TLAST;
  wire conv2D_int16_0_M_AXIS_TREADY;
  wire conv2D_int16_0_M_AXIS_TVALID;
  ...
  test_axis_data_fifo_0_0 axis_data_fifo_out
       (.m_axis_tdata(axis_data_fifo_0_M_AXIS_TDATA),
        ...
        .s_axis_aclk(processing_system7_0_FCLK_CLK0),
        .s_axis_aresetn(rst_ps7_0_50M_interconnect_aresetn),
        .s_axis_tdata(conv2D_int16_0_M_AXIS_TDATA),
        .s_axis_tkeep(conv2D_int16_0_M_AXIS_TKEEP),
        .s_axis_tlast(conv2D_int16_0_M_AXIS_TLAST),
        .s_axis_tready(conv2D_int16_0_M_AXIS_TREADY),
        .s_axis_tvalid(conv2D_int16_0_M_AXIS_TVALID));
  test_conv2D_int16_0_0 conv2D_int16_0
       (.M_AXIS_ACLK(processing_system7_0_FCLK_CLK0),
        .M_AXIS_ARESETN(rst_ps7_0_50M_interconnect_aresetn),
        .M_AXIS_TDATA(conv2D_int16_0_M_AXIS_TDATA),
        .M_AXIS_TKEEP(conv2D_int16_0_M_AXIS_TKEEP),
        .M_AXIS_TLAST(conv2D_int16_0_M_AXIS_TLAST),
        .M_AXIS_TREADY(conv2D_int16_0_M_AXIS_TREADY),
        .M_AXIS_TVALID(conv2D_int16_0_M_AXIS_TVALID),
        .S_AXIS_ACLK(processing_system7_0_FCLK_CLK0),
        .S_AXIS_ARESETN(rst_ps7_0_50M_interconnect_aresetn),
