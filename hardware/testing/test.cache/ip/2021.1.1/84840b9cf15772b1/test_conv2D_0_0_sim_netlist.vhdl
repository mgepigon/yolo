...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_conv2D is
  ...
  attribute SOFT_HLUTNM of \genblk3[2].products_reg[2][2]_i_5\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \state[2]_i_14\ : label is "soft_lutpair3";
...
\genblk3[2].products_reg[2][2]_i_11\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\genblk3[2].products_reg[2][2]_i_12\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\genblk3[2].products_reg[2][2]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFDFFFF"
    )
        port map (
...
\genblk3[2].products_reg[2][2]_i_6\: unisim.vcomponents.LUT6
    generic map(
