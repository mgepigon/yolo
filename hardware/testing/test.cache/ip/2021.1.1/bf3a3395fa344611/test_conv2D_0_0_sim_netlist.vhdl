...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_conv2D is
  ...
  signal \zero_padding__0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \TX_count[0]_i_3\ : label is "soft_lutpair2";
...
M_AXIS_TVALID_INST_0: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => \row_count_reg_n_0_[0]\,
      O => \^m_axis_tvalid\
    );
\TX_count[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"000A800000000000"
    )
        port map (
      I0 => M_AXIS_TREADY,
      I1 => S_AXIS_TVALID,
...
\genblk3[2].products_reg[2][2]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\genblk3[2].products_reg[2][2]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
p_0_out_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAAFEAA"
    )
        port map (
