...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_conv2D is
  port (
    \row_count_reg[1]_0\ : out STD_LOGIC;
    \row_count_reg[0]_0\ : out STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_conv2D is
  ...
  signal \data_count[0]_i_5_n_0\ : STD_LOGIC;
  ...
  signal \^row_count_reg[0]_0\ : STD_LOGIC;
  signal \^row_count_reg[1]_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \row_count[1]_i_2\ : label is "soft_lutpair1";
...
begin
  ...
  \row_count_reg[0]_0\ <= \^row_count_reg[0]_0\;
  \row_count_reg[1]_0\ <= \^row_count_reg[1]_0\;
...
M_AXIS_TVALID_INST_0: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => state(0),
      I3 => state(2),
      I4 => \^row_count_reg[0]_0\,
      I5 => \^row_count_reg[1]_0\,
      O => \^m_axis_tvalid\
    );
\TX_count[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000000000A8000"
    )
        port map (
      I0 => M_AXIS_TREADY,
      I1 => S_AXIS_TVALID,
...
\TX_count[0]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
        ...
        port map (
      I0 => \^row_count_reg[0]_0\,
      I1 => \^row_count_reg[1]_0\,
...
\data_count[0]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\data_count[0]_i_5\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => data_count_reg(0),
      O => \data_count[0]_i_5_n_0\
    );
\data_count_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => S_AXIS_ACLK,
      CE => \data_count[0]_i_2_n_0\,
...
\row_count[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => \^row_count_reg[1]_0\,
      I2 => \^row_count_reg[0]_0\,
      I3 => \row_count[1]_i_2_n_0\,
      I4 => arr_rst,
...
\row_count[1]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_conv2D
     port map (
      ...
      \row_count_reg[0]_0\ => \^m_axis_tdata\(0),
      \row_count_reg[1]_0\ => \^m_axis_tdata\(1)
    );
end STRUCTURE;
